...
import '../../../routes/s_tabs_route/s_4_tabs_route.dart';
...
class S4TabsRouteTranslator<Route extends S4TabsRoute<N>, N extends MaybeSNested>
    extends STabsRouteTranslator<Route, S4TabsState, N> {
  /// {@macro srouter.s_tabs_route_translators.constructor}
  ///
  /// See also:
  ///   - [S4TabsRouteTranslator.parse] for a way to match the path dynamically
  S4TabsRouteTranslator({
    required Route Function(StateBuilder<S4TabsState> stateBuilder) route,
  ...
  @override
  final Route? Function(WebEntryMatch match, StateBuilder<S4TabsState>? stateBuilder)
  matchToRoute;
  ...
  @override
  S4TabsState buildFromSTabsState(int activeIndex, IList<SRouteBase<SNested>> sRoutes) {
    return S4TabsState(
