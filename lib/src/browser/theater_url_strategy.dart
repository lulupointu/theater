...
///   - If you are using [TheaterUrlStrategy.hash], the application will update
///   - If you are using [TheaterUrlStrategy.history], the browser will fetch your
